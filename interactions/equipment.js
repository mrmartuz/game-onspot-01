...
export const equipmentMaterials = {
  ...
  copper: {
    ...
    weight: 4,
    cost: 3,
    description: "Soft reddish metal, easy to work but less durable",
    color: "#B87333",
    allowedTypes: [
      "armor",
      "swords",
  ...
  pig_iron: {
    ...
    weight: 5.5,
    cost: 4,
    description: "High-carbon crude iron, strong but brittle",
    color: "#5E5E5E",
    allowedTypes: [
      "armor",
      "swords",
  ...
  stone: {
    ...
    weight: 6.5,
    cost: 1,
    description: "Chipped stone used for primitive weapon heads",
    color: "#6E6E6E",
    allowedTypes: [
      "axes",
      "hammers",
  ...
  obsidian: {
    ...
    weight: 3,
    cost: 6,
    description: "Volcanic glass with razor edges; brittle on impact",
    color: "#1C1C1C",
    allowedTypes: ["swords", "axes", "polearms", "throwing", "tools"],
  },
...
export const equipmentTypes = {
  ...
  swords: {
    ...
    slot: "weapon",
    statusType: "weapons",
    description: "One-handed swords for combat",
    skillBonuses: {
      swords: 1,
    },
    items: [
  ...
  great_swords: {
    ...
    items: ["greatsword", "claymore", "zweihander", "bastard-sword"],
  },
  axes: {
    name: "Axes",
    slot: "weapon",
    statusType: "weapons",
    description: "One-handed axes for combat",
    skillBonuses: {
      axes: 1,
    },
    items: ["axe", "hatchet", "hand-axe", "tomahawk"],
  },
  great_axes: {
    name: "Great Axes",
    slot: "weapon",
    ...
    items: ["greataxe", "battleaxe", "war-axe", "vrakgul-axe"],
  },
  polearms: {
    name: "Polearms",
    slot: "weapon",
  ...
  hammers: {
    ...
    slot: "weapon",
    statusType: "weapons",
    description: "One-handed hammers and maces",
    skillBonuses: {
      hammers: 1,
    },
    items: ["mace", "club", "warhammer", "flail", "morningstar"],
  },
  great_hammers: {
    name: "Great Hammers",
    slot: "weapon",
    ...
    items: ["maul", "great-hammer", "war-hammer", "gormith-hammer"],
  },
  bows: {
    name: "Bows",
    slot: "weapon",
  ...
  crossbows: {
    ...
    items: ["crossbow", "heavy-crossbow", "light-crossbow", "gormith-crossbow"],
  },
  throwing: {
  ...
  great_shields: {
    ...
    items: ["tower-shield", "pavise", "great-shield"],
  },
  ranged: {
    name: "Ranged Weapon",
    slot: "weapon",
