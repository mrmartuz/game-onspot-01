        ...
        if (components && components.length > 0) {
            components.forEach(({type, label, value}) => {
                ...
                switch (component.type) {
                    case 'button':const btnDiv = document.createElement('div');
                    ...
                    case 'input':
                        ...
                        if (component.value === 'seed') {
                            ...
                            if (input.value && input.value.length === 9 && input.value.match(/^\d+$/)) {
                    ...
                    case 'message':
                        ...
                        break;
                    default:
                        console.warn('getShowChoiceDialog: Unknown component type: ' + components.type);
                        break;
                    }
            });
        } else {
            console.warn('getShowChoiceDialog: No components provided, adding fallback Close button');
